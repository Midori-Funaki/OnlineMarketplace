...
var FavRoutes = require('./routes/favorite-routes');
...
var FavService = require('./services/favorite-service');
...
var favouriteService = new FavService();
...
app.use('/api/favourite', new FavRoutes(favouriteService).router());
