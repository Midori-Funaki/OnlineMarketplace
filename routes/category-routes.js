...
class CategoryRoutes {
  ...
  router() {
    ...
    router.get('/name/:id',this.getBrandName.bind(this));
  ...
  getBrandName(req,res) {
    console.log('req.body @ category route ',req.params.id)
    return this.categoryService.getBrandName(req.params.id)
